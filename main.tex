...
\newcommand{\etc}{\cdots} %et cetera, with centered dots
\newcommand{\etl}{\ldots} %et cetera, with lowered dots
...
\newcommand{\free}{\freebase} %the set of free variables occurring in the formula #1
